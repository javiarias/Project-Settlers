...
var Tutorial = {
  ...
  //Tutorial Roads
    ...
    roadBttn.visible = false;
    roadBttn.input.enabled = false;
  ...
  //Tutorial Houses
    ...
    houseBttn.visible = false;
    houseBttn.input.enabled = false;
    ...
    cropBttn.visible = false;
    cropBttn.input.enabled = false;
    ...
    woodBttn.visible = false;
    woodBttn.input.enabled = false;
    ...
    stoneBttn.visible = false;
    stoneBttn.input.enabled = false;
    ...
    bulldozeBttn.visible = false;
    bulldozeBttn.input.enabled = false;
    ...
    //var Roadcheck = new Boolean(false);
    var HouseCheck = false;
    var CropCheck = false;
    var StoneCheck = false;
    var WoodCheck = false;
    var BulldozeCheck = false;
    //var CitizenCheck = false;
    ...
    function build(){
      ...
      if(!overlap && !mountainObstacle && (this._buildingModeType == this.roadGroup || (roadAdjacency && this.wood >= 10 && this.stone >= 10 && !waterObstacle))){
        ...
        else
        {
          ...
          if (!CropCheck && this._buildingModeType.sprite == 'Crops')
            CropCheck = true;

          if (!StoneCheck && this._buildingModeType.sprite == 'Stone')
            StoneCheck = true;

          if (!WoodCheck && this._buildingModeType.sprite == 'Wood')
            WoodCheck = true;
        }
  ...
  update: function () {
    ...
    var CameraCheckUp = false;
    var CameraCheckDown = false;
    var CameraCheckLeft = false;
    var CameraCheckRight = false;
    var TimeCheck = false;
